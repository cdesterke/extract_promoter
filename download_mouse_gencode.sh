...
# URL of the page containing Gencode files for Mus musculus
GENCODE_URL="https://www.gencodegenes.org/mouse/"
OUTPUT_DIR="mouse"
...
usage() {
    echo "Usage : $0"
    echo "\nThis script downloads the latest GTF file from Gencode for Mus musculus, decompresses it, and installs it into a 'mouse' directory."
...
# Main function
main() {
    echo "Gencode GTF File Download Script for Mus musculus"
